...
export const Home = () => {
  ...
  return (
    <div className="space-y-12 sm:space-y-16 pb-16 font-body text-start bg-[#F9F6F0]">
      ...
      <section className="relative w-full bg-[#351809] text-white overflow-hidden min-h-[440px] sm:min-h-[540px] flex items-center justify-center border-b border-[#5C2D15] shadow-2xl">
        ...
        {/* Desert Warm Overlay */}
        <div className="absolute inset-0 bg-gradient-to-t from-[#351809]/95 via-[#351809]/60 to-[#351809]/40 z-0" />
